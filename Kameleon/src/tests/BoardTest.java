...
public class BoardTest {
	...
	public static void main(String[] args) throws IOException {
		...
		players[1] = new Player(Player.Colour.Green, "Ruben XII");
		players[2] = new Player(Player.Colour.Blue, "Ruben XII");
		players[3]= new Player(Player.Colour.Yellow, "Ruben XII");
